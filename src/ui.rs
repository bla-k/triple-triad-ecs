...
impl Default for Hand {
    fn default() -> Self {
        Hand {
            p1: [
                Rect::new(36, 95, 126, 126),
                Rect::new(36, 174, 126, 126),
                Rect::new(36, 253, 126, 126),
                Rect::new(36, 332, 126, 126),
                Rect::new(36, 411, 126, 126),
            ],
            p2: [
                Rect::new(638, 95, 126, 126),
                Rect::new(638, 174, 126, 126),
                Rect::new(638, 253, 126, 126),
                Rect::new(638, 332, 126, 126),
                Rect::new(638, 411, 126, 126),
            ],
        }
    }
}
